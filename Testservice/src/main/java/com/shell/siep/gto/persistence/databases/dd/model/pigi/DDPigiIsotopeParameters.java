...
public class DDPigiIsotopeParameters extends DDDatabaseObject implements GTOPigiIsotopeParameters, Serializable {
	...
	private DDIsotopesRock isotopesRock;
	...
	@JoinColumn(updatable=false,insertable=false, name="REQUEST_ID", referencedColumnName="REQUEST_ID")
	@LazyCollection(LazyCollectionOption.FALSE)
	private DDIsotopesGas isotopesGas;
